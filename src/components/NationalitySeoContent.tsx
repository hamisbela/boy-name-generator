...
const nationalityContent: { [key: string]: { title: string; description: string; facts: string[]; usage: string[] } } = {
  african: {
    title: "African Boy Names - Traditional & Modern African Baby Names",
  ...
  american: {
    ...
    usage: [
      ...
      "Click generate to see popular American boy names",
      "Each name reflects modern American naming trends",
      "Keep generating until you find your perfect match"
    ]
  },
  french: {
    title: "French Boy Names - Strong & Classic French Baby Names",
    ...
    usage: [
      ...
      "Generate to discover elegant French boy names",
      "Each suggestion maintains authentic French style",
      "Continue generating to explore more options"
    ]
  },
  german: {
    title: "German Boy Names - Traditional & Modern German Baby Names",
    description: "German names combine strength with heritage, often drawing from historical and mythological sources. These names frequently have clear meanings and strong cultural connections.",
    facts: [
    ...
    usage: [
      ...
      "Generate to see authentic German boy names",
      "Each name reflects German naming traditions",
      "Generate multiple times to explore more options"
    ]
  },
  indian: {
    title: "Indian Boy Names - Strong & Meaningful Indian Baby Names",
  ...
  japanese: {
    title: "Japanese Boy Names - Traditional & Modern Japanese Baby Names",
    description: "Japanese names are chosen with great care, often combining strong sounds with meaningful kanji characters. These names frequently reflect natural elements and positive attributes.",
    facts: [
    ...
    usage: [
      ...
      "Generate to see authentic Japanese boy names",
      "Each name follows Japanese naming conventions",
      "Generate new sets to explore more options"
    ]
  },
  russian: {
    title: "Russian Boy Names - Classic & Strong Russian Baby Names",
    ...
    usage: [
      ...
      "Generate to discover Russian boy names",
  ...
  return (
    <section className="prose lg:prose-lg mx-auto">
      ...
      <h3 className="text-xl font-bold text-gray-800 mb-4">
        How to Use Our {nationality.charAt(0).toUpperCase() + nationality.slice(1)} Boy Name Generator
      </h3>
      ...
      <h3 className="text-xl font-bold text-gray-800 mb-4">
        About {nationality.charAt(0).toUpperCase() + nationality.slice(1)} Boy Names
      </h3>
      <ul className="list-disc pl-6 text-gray-600 mb-6">
      ...
      <p className="text-gray-600 mb-6">
        When selecting a {nationality} name for your baby boy, consider the following:
      </p>
      <ul className="list-disc pl-6 text-gray-600 mb-6">
